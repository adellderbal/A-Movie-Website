		...
		<!-- Header -->
			<div id="header">
				<div class="container">
					...
					<!-- Logo -->
						<h2><a href="#" id="logo">All Movies</a></h2>
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								echo"<li>";
									echo"<a href=>Genres</a>";
									echo"<ul>";
									// Attempt select query execution
									$sql3 = "SELECT gen_name, genre_id from genre;";
									if($result3 = mysqli_query($db, $sql3)){
									
									if(mysqli_num_rows($result3) > 0){
										while($row3 = mysqli_fetch_array($result3)){
											$x1++;
											$gen_id[$x1]=$row3['genre_id'];
											$y1++;
											echo"<li><a href=genre.php?gen=$gen_id[$y1]>".$row3['gen_name']."</a></li>";											
										 }
									}
									}
									echo"</ul>";
...
// Attempt select query execution
$sql = "SELECT mov_id,title,rl_date,length,lang,g.gen_name as genre,prating FROM movies,genre g where movies.genre_id=g.genre_id ";
